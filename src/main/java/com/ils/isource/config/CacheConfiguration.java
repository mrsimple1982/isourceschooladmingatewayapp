...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("isourceschooladmingatewayapp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("isourceschooladmingatewayapp");
        ...
        config.getMapConfigs().put("com.ils.isource.domain.*", initializeDomainMapConfig(jHipsterProperties));
