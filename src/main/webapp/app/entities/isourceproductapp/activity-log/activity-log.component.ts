...
export class ActivityLogComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.activityLogService
      ...
      .subscribe(
        (res: HttpResponse<IActivityLog[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  ngOnInit(): void {
    ...
    this.registerChangeInActivityLogs();
  }
  ...
  trackId(index: number, item: IActivityLog): number {
  ...
  registerChangeInActivityLogs(): void {
    this.eventSubscriber = this.eventManager.subscribe('activityLogListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IActivityLog[] | null, headers: HttpHeaders, page: number): void {
