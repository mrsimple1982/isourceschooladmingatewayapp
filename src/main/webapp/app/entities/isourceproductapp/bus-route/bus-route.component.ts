...
export class BusRouteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.busRouteService
      ...
      .subscribe(
        (res: HttpResponse<IBusRoute[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInBusRoutes(): void {
    this.eventSubscriber = this.eventManager.subscribe('busRouteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IBusRoute[] | null, headers: HttpHeaders, page: number): void {
