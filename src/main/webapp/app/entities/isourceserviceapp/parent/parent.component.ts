...
export class ParentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.parentService
      ...
      .subscribe(
        (res: HttpResponse<IParent[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInParents(): void {
    this.eventSubscriber = this.eventManager.subscribe('parentListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IParent[] | null, headers: HttpHeaders, page: number): void {
