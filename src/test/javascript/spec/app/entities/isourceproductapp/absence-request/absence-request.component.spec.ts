...
import { AbsenceRequestComponent } from 'app/entities/isourceproductapp/absence-request/absence-request.component';
...
describe('Component Tests', () => {
  describe('AbsenceRequest Management Component', () => {
    let comp: AbsenceRequestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AbsenceRequestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.absenceRequests && comp.absenceRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
