...
import { ActivityLogDeleteDialogComponent } from 'app/entities/isourceproductapp/activity-log/activity-log-delete-dialog.component';
  ...
  describe('ActivityLog Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ActivityLogDeleteDialogComponent],
      })
