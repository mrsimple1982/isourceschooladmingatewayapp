...
import { PickupRequestComponent } from 'app/entities/isourceproductapp/pickup-request/pickup-request.component';
...
describe('Component Tests', () => {
  describe('PickupRequest Management Component', () => {
    let comp: PickupRequestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PickupRequestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pickupRequests && comp.pickupRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
